                                            ...
                                            <div className="uk-grid uk-grid-small@m uk-flex-column uk-flex-top" data-uk-grid>
                                                ...
                                                <div className="uk-width-expand@m">
                                                    <div className="content uk-panel">
                                                        <h3 className="title uk-h5 uk-font-display uk-text-uppercase uk-margin-remove">Discover the Concept</h3>
                                                        <p className="description uk-text-muted dark:uk-text-gray-40">Unveil our groundbreaking NFT project! Explore unique art, endless possibilities.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div className="uni-minting-item uk-card uk-card-medium uk-card-border uk-card-default uk-height-large@m uk-radius-medium uk-radius-large@m uk-margin-large-top@m dark:uk-background-white-5">
                                            <div className="uk-grid uk-grid-small@m uk-flex-column uk-flex-top" data-uk-grid>
                                                ...
                                                <div className="uk-width-expand@m">
                                                    <div className="content uk-panel">
                                                        <h3 className="title uk-h5 uk-font-display uk-text-uppercase uk-margin-remove">Connect Your Wallet</h3>
                                                        <p className="description uk-text-muted dark:uk-text-gray-40">Mint your exclusive NFT by connecting your wallet securely.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div className="uni-minting-item uk-card uk-card-medium uk-card-border uk-card-default uk-height-large@m uk-radius-medium uk-radius-large@m dark:uk-background-white-5">
                                            <div className="uk-grid uk-grid-small@m uk-flex-column uk-flex-top" data-uk-grid>
                                                ...
                                                <div className="uk-width-expand@m">
                                                    <div className="content uk-panel">
                                                        <h3 className="title uk-h5 uk-font-display uk-text-uppercase uk-margin-remove">Select Your Masterpiece</h3>
                                                        <p className="description uk-text-muted dark:uk-text-gray-40">Browse stunning artwork, find an NFT that reflects your style.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div className="uni-minting-item uk-card uk-card-medium uk-card-border uk-card-default uk-height-large@m uk-radius-medium uk-radius-large@m dark:uk-background-white-5">
                                            <div className="uk-grid uk-grid-small@m uk-flex-column uk-flex-top" data-uk-grid>
                                                ...
                                                <div className="uk-width-expand@m">
                                                    <div className="content uk-panel">
                                                        <h3 className="title uk-h5 uk-font-display uk-text-uppercase uk-margin-remove">Mint and Own</h3>
                                                        <p className="description uk-text-muted dark:uk-text-gray-40">With a few clicks, own an exclusive token recorded on the blockchain.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
